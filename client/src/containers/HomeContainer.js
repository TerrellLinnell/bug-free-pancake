...
class HomeContainer extends Component {
  ...
  render () {
    return (
      ...
      <div>
        {this.state.game ? <HomeForm onSubmitHandler={this.onSubmitHandler} game={this.state.game} onChangeHandler={this.onChangeHandler} gameId={this.state.game._id}/> : null}
      </div>
      <div>
